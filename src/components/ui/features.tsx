...
export default function Features() {
  return (
    <div className="overflow-hidden bg-none py-24 sm:py-32 dark:text-white text-primary">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              <h2 className="text-primary font-semibold leading-7">Manage Your Business</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-white-900 sm:text-4xl dark:text-white">All-In-One Agency Management Suite</p>
              ...
              <dl className="mt-10 max-w-xl space-y-8 dark:text-white leading-7 text-white-600 lg:max-w-none text-black">
